...
exports.AddCronRequest = {
    ...
    fromJSON(object) {
        return {
            crons: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.crons) ? object.crons.map((e) => exports.ICron.fromJSON(e)) : [],
    ...
    fromPartial(object) {
        ...
        message.replace = (_b = object.replace) !== null && _b !== void 0 ? _b : false;
        return message;
    },
};
