...
const systemNotify = async (call, callback) => {
    try {
        ...
        const data = await systemService.notify({
            ...
            notificationInfo: call.request.notificationInfo,
        });
        callback(null, data);
    }
    catch (e) {
...
const normalizeCronData = (data) => {
    ...
    const cron = data instanceof sequelize_1.Model ? data.get({ plain: true }) : data;
    return Object.assign(Object.assign({}, cron), { labels: (_a = cron.labels) !== null && _a !== void 0 ? _a : [], sub_id: (_b = cron.sub_id) !== null && _b !== void 0 ? _b : undefined, extra_schedules: (_c = cron.extra_schedules) !== null && _c !== void 0 ? _c : [], pid: (_d = cron.pid) !== null && _d !== void 0 ? _d : undefined, task_before: (_e = cron.task_before) !== null && _e !== void 0 ? _e : undefined, task_after: (_f = cron.task_after) !== null && _f !== void 0 ? _f : undefined });
};
