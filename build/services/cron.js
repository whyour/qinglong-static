...
let CronService = class CronService {
    ...
    isSixCron(cron) {
        const { schedule } = cron;
        if (Number(schedule === null || schedule === void 0 ? void 0 : schedule.split(/ +/).length) > 5) {
            return true;
        }
        return false;
    }
    async create(payload) {
        ...
        if (this.isSixCron(doc) || ((_a = doc.extra_schedules) === null || _a === void 0 ? void 0 : _a.length)) {
    ...
    async update(payload) {
        ...
        if (this.isSixCron(newDoc) || ((_b = newDoc.extra_schedules) === null || _b === void 0 ? void 0 : _b.length)) {
            await client_1.default.addCron([
                {
                    name: doc.name || '',
                    id: String(newDoc.id),
