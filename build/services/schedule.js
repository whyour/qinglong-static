...
let ScheduleService = class ScheduleService {
    ...
    async runTask(command, callbacks = {}) {
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                // TODO:
                (_a = callbacks.onStart) === null || _a === void 0 ? void 0 : _a.call(callbacks, cp, startTime);
                ...
                await ((_b = callbacks.onError) === null || _b === void 0 ? void 0 : _b.call(callbacks, JSON.stringify(error)));
                resolve(null);
            }
        });
    }
    async createCronTask({ id = 0, command, name, schedule = '' }, callbacks) {
    ...
    async createIntervalTask({ id = 0, command, name = '' }, schedule, runImmediately = true, callbacks) {
        ...
        const job = new toad_scheduler_1.LongIntervalJob(Object.assign(Object.assign({}, schedule), { runImmediately }), task, _id);
