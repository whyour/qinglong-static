...
class WpushNotification extends NotificationBaseInfo {
    constructor() {
        super(...arguments);
        this.wpushApiKey = '';
        this.wpushChannel = '';
...
exports.WpushNotification = WpushNotification;
