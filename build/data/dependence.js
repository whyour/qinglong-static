...
(function (InstallDependenceCommandTypes) {
    ...
    InstallDependenceCommandTypes[InstallDependenceCommandTypes["apk add --no-check-certificate"] = 2] = "apk add --no-check-certificate";
...
(function (GetDependenceCommandTypes) {
    ...
    GetDependenceCommandTypes[GetDependenceCommandTypes["apk info -es"] = 2] = "apk info -es";
