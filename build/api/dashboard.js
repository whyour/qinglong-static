...
exports.default = (app) => {
    ...
    route.get('/failures', async (req, res, next) => {
        try {
            const rows = (await cronStats_1.CrontabStatModel.findAll({
                attributes: ['ref_id', [(0, sequelize_1.fn)('SUM', (0, sequelize_1.col)('fail_count')), 'fail_count']],
                where: { date: (0, dayjs_1.default)().format('YYYY-MM-DD'), fail_count: { [sequelize_1.Op.gt]: 0 } },
                group: ['ref_id'],
                order: [[(0, sequelize_1.fn)('SUM', (0, sequelize_1.col)('fail_count')), 'DESC'], ['ref_id', 'ASC']],
                raw: true,
            }));
