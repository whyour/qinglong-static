...
function isPathAllowed(targetPath) {
    ...
    return config_1.default.writePathList.some((x) => Boolean((0, fileAccess_1.resolveFileAccess)(x, [resolved], config_1.default.blackFileList)));
}
...
exports.default = (app) => {
    ...
    route.get('/', (0, celebrate_1.celebrate)({
        ...
        try {
            ...
            if (req.query.path) {
                if (!(0, fileAccess_1.resolveFileAccess)(config_1.default.scriptPath, [req.query.path], config_1.default.blackFileList)) {
