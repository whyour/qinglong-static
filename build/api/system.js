...
exports.default = (app) => {
    ...
    route.get('/', async (req, res, next) => {
        ...
        try {
            ...
            const lastCommitTime = (await (0, util_1.promiseExec)('git show -s --format=%ai')).replace('\n', '');
            const lastCommitId = (await (0, util_1.promiseExec)('git rev-parse --short HEAD')).replace('\n', '');
            const branch = (await (0, util_1.promiseExec)('git symbolic-ref --short HEAD')).replace('\n', '');
