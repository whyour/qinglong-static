...
exports.default = (app) => {
    ...
    route.delete('/labels', celebrate_1.celebrate({
        body: celebrate_1.Joi.object({
    ...
    route.post('/labels', celebrate_1.celebrate({
        body: celebrate_1.Joi.object({
            ids: celebrate_1.Joi.array().items(celebrate_1.Joi.number().required()),
            labels: celebrate_1.Joi.array().items(celebrate_1.Joi.string().required()),
        }),
    ...
    route.get('/:id/log', celebrate_1.celebrate({
    ...
    route.put('/pin', celebrate_1.celebrate({
        body: celebrate_1.Joi.array().items(celebrate_1.Joi.number().required()),
    }), async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
    ...
    route.put('/unpin', celebrate_1.celebrate({
        body: celebrate_1.Joi.array().items(celebrate_1.Joi.number().required()),
    }), async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
    ...
    route.put('/status', celebrate_1.celebrate({
        body: celebrate_1.Joi.object({
            ids: celebrate_1.Joi.array().items(celebrate_1.Joi.number().required()),
            status: celebrate_1.Joi.string().required(),
            pid: celebrate_1.Joi.string().optional(),
            log_path: celebrate_1.Joi.string().optional(),
            last_running_time: celebrate_1.Joi.number().optional(),
            last_execution_time: celebrate_1.Joi.number().optional(),
        }),
    }), async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
