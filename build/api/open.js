...
exports.default = (app) => {
    ...
    route.post('/apps', celebrate_1.celebrate({
    ...
    route.put('/apps', celebrate_1.celebrate({
        body: celebrate_1.Joi.object({
            name: celebrate_1.Joi.string().optional().allow(''),
    ...
    route.delete('/apps', celebrate_1.celebrate({
    ...
    route.put('/apps/:id/reset-secret', celebrate_1.celebrate({
    ...
    route.get('/auth/token', celebrate_1.celebrate({
        query: {
