...
exports.default = (app) => {
    ...
    route.post('/', (0, celebrate_1.celebrate)({
        body: celebrate_1.Joi.object({
            ...
            proxy: celebrate_1.Joi.string().optional().allow('').allow(null),
            autoAddCron: celebrate_1.Joi.boolean().optional().allow('').allow(null),
            autoDelCron: celebrate_1.Joi.boolean().optional().allow('').allow(null),
        }),
    }), async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
    ...
    route.get('/:id/log', (0, celebrate_1.celebrate)({
        ...
        try {
            ...
            return res.send(Object.assign({ code: 200, data: result.content }, result));
        }
        catch (e) {
            return next(e);
        }
